      ...
      <div className="relative flex flex-col gap-y-2 z-10">
        ...
        <div className="flex items-center justify-between mb-2 ">
          <h3
            ...
            style={{ color: `${categoryObj.category_color}` }}
          >
        ...
        <div className="w-full h-4 bg-lightAccent3 rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${(spendTotal / categoryObj.category_budget) * 100}%`,
              backgroundColor: `${categoryObj.category_color}`,
            }}
          />
        </div>
